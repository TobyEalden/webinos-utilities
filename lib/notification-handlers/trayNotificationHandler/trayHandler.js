    ...
    notificationManager.on(notificationManager.notifyType.all, function(notify) {
      ...
      switch (notify.type) {
        ...
        case notificationManager.notifyType.appgTransactionResponse:
          msg = "Payment confirmed - " + notify.data.origin + " payment of " + notify.data.value + notify.data.currency + " via " + notify.data.source + " to " + notify.data.destination + " for " + notify.data.description;
          break;
        default:
          break;
      }
